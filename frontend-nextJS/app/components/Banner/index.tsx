                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1'>
                    ...
                    <div className='col-span-6 flex flex-col justify-evenly'>
                        <div className='flex gap-2 mx-auto lg:mx-0'>
                            ...
                            <h3 className='text-kellygreen text-sm font-semibold text-center lg:text-start'>Get Listed in Our Job Portal After Successful Course Project Completion</h3>
                        </div>
